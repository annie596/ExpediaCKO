...
$(window).scroll(function(e) {
    ...
    if ($(window).width() >= 880 && $(this).scrollTop() >= scroller_anchor && $('.scroller').css('position') != 'fixed') {
        $('.scroller').css({
            'position': 'fixed',
            'top': '10px'
        });
    ...
    } else if ($(window).width() >= 880 && $(this).scrollTop() < scroller_anchor && $('.scroller').css('position') != 'relative') {
